...
const Contact = () => {
    ...
    return (
        <div className='dark:bg-gray-900'>
            ...
            <section
                class="relative z-10 overflow-hidden bg-white dark:bg-[#111928] py-20 lg:py-[120px]"
            >
                    ...
                    <div class="flex flex-wrap -mx-4 lg:justify-between">
                        <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div class="mb-12 max-w-[570px] lg:mb-0">
                                ...
                                <p
                                    class="text-base leading-relaxed text-body-color dark:text-white mb-9"
                                >
                                ...
                                <div class="mb-8 flex w-full max-w-[370px]">
                                    <div
                                        class="bg-primary/5 text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center dark:text-white justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px]"
                                    >
                                        <svg
                                            width="32"
                                            height="32"
