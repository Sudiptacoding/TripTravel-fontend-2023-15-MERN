...
const UsersProfile = () => {
    ...
    const handelSubmitStory = (e) => {
        ...
        const storyData = { userName, userEmail, userPhoto, story, time }
        axiosData.post('/userstory', storyData)
            .then(res => {
                    ...
                    <div className="lg:w-1/2 lg:mx-10">
                        ...
                        <form onSubmit={handelSubmitStory} className="mt-12">
                            ...
                            <div className="w-full mt-4">
                                <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200">Story</label>
                                <textarea name='story' className="block w-full h-32 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md md:h-56 dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Write your story"></textarea>
                            </div>
